...
const arr = [
  ...
  },
  {
    ...
    bigPic: require('@/assets/images/bighouse.png'),
    pics: [
      { src: require('@/assets/images/D1.jpg'), isVideo: false },
      { src: require('@/assets/images/D2.jpg'), isVideo: false },
      { src: require('@/assets/images/D3.jpg'), isVideo: false },
      { src: require('@/assets/images/D4.jpg'), isVideo: false },
      { src: require('@/assets/images/D5.jpg'), isVideo: false },
      { src: require('@/assets/images/D6.jpg'), isVideo: false },
      { src: require('@/assets/images/D7.jpg'), isVideo: false },
      { src: require('@/assets/images/D8.jpg'), isVideo: false },
      { src: require('@/assets/images/D9.jpg'), isVideo: false },
      { src: require('@/assets/images/D10.jpg'), isVideo: false },
    ],
  },
  {
    title: 'Bath_Proj',
